...
const Hero = () => {
  return (
    <section
      className="hero min-h-screen flex items-center pt-40 pb-10 md:pt-20"
      id="home"
    >
      <div className="flex mx-auto lg:items-center">
        <div className="text-center flex flex-col gap-6 lg:text-left lg:max-w-120 md:max-w-120">
          <h1
            className="text-2xl leading-6 font-bold xl:text-3xl"
            data-aos="fade-up"
          >
          ...
          <p
            className="opacity-70 leading-5"
            data-aos="fade-up"
            data-aos-delay="400"
          >
          ...
          <div
            className="flex border-y-1 border-white/50 w-fit py-3 px-6 mx-auto items-center gap-2 lg:mx-0"
            data-aos="fade-right"
            data-aos-delay="600"
          >
            <img
